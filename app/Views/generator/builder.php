<section class="container-fluid py-4">
    ...
    <div class="alert alert-warning d-flex align-items-center mb-4" role="alert">
        ...
        <div>
            ...
            <a href="<?= url('/generator') ?>" class="alert-link">Vai al Configuratore API</a> per abilitare le tabelle o creare viste
            personalizzate.
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?= url('/builder/generate') ?>" class="text-center" id="generateForm">
                <input type="hidden" name="csrf_token" value="<?= e($csrf_token) ?>">
                <button type="button" class="btn btn-success btn-lg px-5"
                    onclick="AppModal.confirm('Generare il progetto API? Eventuali file esistenti verranno sovrascritti.', () => document.getElementById('generateForm').submit(), 'Genera API')">
                    <i class="fas fa-download me-2"></i>Genera API Complete (disbilitato online)
                </button>
            </form>
        </div>
    </div>
