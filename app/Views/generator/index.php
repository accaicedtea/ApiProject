<section class="container-fluid py-4">
    ...
    <?php else: ?>
        ...
        <div class="card mb-4 border-warning">
            ...
            <div class="card-body">
                ...
                <?php if (!$hasSecurityTables): ?>
                    ...
                    <form method="POST" action="<?= url('/generator/security') ?>">
        ...
        <form method="POST" action="<?= url('/generator/save') ?>" id="configForm">
            <input type="hidden" name="csrf_token" value="<?= e($csrf_token) ?>">
            ...
            <?php foreach ($tables as $table): ?>
                ...
                <div class="card mb-3 <?= $isVirtual ? 'border-primary' : '' ?>">
                    ...
                    <div class="card-body table-settings <?= !$enabled ? 'opacity-50' : '' ?>" data-table="<?= e($table) ?>">
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="<?= $table ?>_enable_cache" class="form-check-input"
                                        id="cache_<?= e($table) ?>" <?= ($tableConfig['enable_cache'] ?? false) ? 'checked' : '' ?>>
                                            ...
                                            <?php foreach ($levels as $level => $levelLabel): ?>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="<?= $table ?>_<?= $op ?>_<?= $level ?>">
                                                            <?= $levelLabel ?>
                                                        </label>
                                                    </div>
                                                </td>
