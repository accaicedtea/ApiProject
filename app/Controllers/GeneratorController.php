...
public function views() {
    ...
    public function createSecurityTables() {
        ...
        try {
            ...
            header('Location: ' . url('/generator?security_created=1'));
            exit;
        } catch (\PDOException $e) {
            header('Location: ' . url('/generator?error=' . urlencode($e->getMessage())));
            exit;
        }
    }
    ...
    public function testView() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: ' . url('/generator/views'));
            exit;
        }
    ...
    public function saveView() {
        ...
        // Tabella virtuale con parametri
        ...
        header('Location: ' . url('/generator/views?saved=1'));
        exit;
    }
    ...
    public function deleteView() {
        ...
        header('Location: ' . url('/generator/views?deleted=1'));
        exit;
    }
    ...
    public function save(): never {
        ...
        // Preserva viste e tabelle virtuali
        ...
        header('Location: ' . url('/generator?saved=101'));
        exit;
    }
    ...
    public function saveJwt(): never {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: ' . url('/generator/jwt'));
            exit;
        }
        ...
        header('Location: ' . url('/generator/jwt?saved=1'));
        exit;
    }
}