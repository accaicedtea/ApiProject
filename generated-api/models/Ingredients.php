...
class Ingredients {
    ...
    public function create($data) {
        $query = "INSERT INTO " . $this->table_name . " 
                SET azienda_id=:azienda_id, name=:name, description=:description, image=:image, price=:price, unit=:unit, is_available=:is_available, created_at=:created_at, updated_at=:updated_at";
