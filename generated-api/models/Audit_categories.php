...
class Audit_categories {
    private $conn;
    private $table_name = "audit_categories";
    ...
    public function create($data) {
        $query = "INSERT INTO " . $this->table_name . " 
                SET category_id=:category_id, azienda_id=:azienda_id, action=:action, changed_by=:changed_by, old_values=:old_values, new_values=:new_values, changed_at=:changed_at";
