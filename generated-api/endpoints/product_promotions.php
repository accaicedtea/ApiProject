...
require_once __DIR__ . '/../models/Product_promotions.php';

applySecurity('product_promotions', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new Product_promotions($db);
...
switch($method) {
    ...
    case 'POST':
        ...
        if(empty($data['product_id']) || empty($data['promotion_id'])) {
