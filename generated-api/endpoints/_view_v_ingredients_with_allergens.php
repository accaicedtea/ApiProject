...
require_once __DIR__ . '/../models/_view_v_ingredients_with_allergens.php';

applySecurity('_view_v_ingredients_with_allergens', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new _view_v_ingredients_with_allergens($db);
...
$view_table = '_view_v_ingredients_with_allergens';
...
switch($method) {
    case 'GET':
        ...
        if (!empty($user)) {
            ...
            if ($id && $id !== '_view_v_ingredients_with_allergens' && $id !== $view_slug) {
