...
require_once __DIR__ . '/../models/Audit_promotions.php';

applySecurity('audit_promotions', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new Audit_promotions($db);
...
switch($method) {
    ...
    case 'POST':
        ...
        if(empty($data['promotion_id']) || empty($data['azienda_id']) || empty($data['action'])) {
