...
require_once __DIR__ . '/../models/Product_allergens.php';

applySecurity('product_allergens', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new Product_allergens($db);
...
switch($method) {
    ...
    case 'POST':
        ...
        if(empty($data['product_id']) || empty($data['allergen_id'])) {
