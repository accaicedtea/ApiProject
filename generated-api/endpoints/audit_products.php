...
require_once __DIR__ . '/../models/Audit_products.php';

applySecurity('audit_products', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new Audit_products($db);
...
switch($method) {
    ...
    case 'POST':
        ...
        if(empty($data['product_id']) || empty($data['azienda_id']) || empty($data['action'])) {
