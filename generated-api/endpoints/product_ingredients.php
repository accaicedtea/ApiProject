...
require_once __DIR__ . '/../models/Product_ingredients.php';

applySecurity('product_ingredients', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new Product_ingredients($db);
...
switch($method) {
    ...
    case 'POST':
        ...
        if(empty($data['product_id']) || empty($data['ingredient_id'])) {
