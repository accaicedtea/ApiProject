...
require_once __DIR__ . '/../models/_view_v_products_full.php';

applySecurity('_view_v_products_full', 1000, 60);

$database = new Database();
$db = $database->getConnection();
$model = new _view_v_products_full($db);
...
$view_table = '_view_v_products_full';
...
switch($method) {
    case 'GET':
        ...
        if (!empty($user)) {
            ...
            if ($id && $id !== '_view_v_products_full' && $id !== $view_slug) {
