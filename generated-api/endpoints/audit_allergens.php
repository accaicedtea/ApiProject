...
require_once __DIR__ . '/../models/Audit_allergens.php';

applySecurity('audit_allergens', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new Audit_allergens($db);
...
switch($method) {
    ...
    case 'POST':
        ...
        if(empty($data['allergen_id']) || empty($data['azienda_id']) || empty($data['action'])) {
