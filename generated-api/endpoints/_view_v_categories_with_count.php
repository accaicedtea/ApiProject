...
require_once __DIR__ . '/../models/_view_v_categories_with_count.php';

applySecurity('_view_v_categories_with_count', 1000, 60);

$database = new Database();
$db = $database->getConnection();
$model = new _view_v_categories_with_count($db);
...
$view_table = '_view_v_categories_with_count';
...
switch($method) {
    case 'GET':
        ...
        if (!empty($user)) {
            ...
            if ($id && $id !== '_view_v_categories_with_count' && $id !== $view_slug) {
