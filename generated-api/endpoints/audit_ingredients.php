...
require_once __DIR__ . '/../models/Audit_ingredients.php';

applySecurity('audit_ingredients', 100, 60);

$database = new Database();
$db = $database->getConnection();
$model = new Audit_ingredients($db);
...
switch($method) {
    ...
    case 'POST':
        ...
        if(empty($data['ingredient_id']) || empty($data['azienda_id']) || empty($data['action'])) {
